function saveEcgBeats(filesFolder, filesName , fs, destFolder)
...
%     peaks = PeakDetectionProbabilistic(ppecg, fs, peak_detector_params);
    ...
    [EcgBeats, rp, ~] = ecgBeats(ppecg, fs, peaks, abs(rpr));
    save([destFolder filesName{i}(1:end-4) '_beats.mat'], 'EcgBeats', 'rp')   
end
